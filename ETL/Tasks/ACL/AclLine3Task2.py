# Скрипт обработки и записи воздействий по 3 линии правки
...
class AclAddNewAction(Construct):
    ...
    def __init__(self):
        ...
        self.pg_query_insert_actions = """
                                  INSERT INTO acl.line3_actions (bar, curvature, action, out_curvature, length_bar,
