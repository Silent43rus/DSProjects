# Скрипт записи таблицы кривизна-воздействие при ее смене на 1 линии правки
...
class AclUpdateCurvTabe(Construct):
    ...
    def __init__(self):
        ...
        self.pg_query_add_curvtable = """INSERT INTO acl.line1_curvature_table (dt_start, curvature1, action1, curvature2, action2, 
        ...
        self.pg_query_upd_curvtable = """UPDATE acl.line1_curvature_table SET dt_stop = CURRENT_TIMESTAMP WHERE dt_stop is null"""
        self.pg_query_select_curvtable = """SELECT dt_start, dt_stop, curvature1, action1, curvature2, action2, 
                                                                curvature3, action3, curvature4, action4, curvature5, action5,
                                                                curvature6, action6, curvature7, action7, curvature8, action8,
                                                                curvature9, action9, curvature10, action10
                           FROM acl.line1_curvature_table"""
