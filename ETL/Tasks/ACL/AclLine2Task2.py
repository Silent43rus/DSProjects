# Скрипт обработки и записи воздействий по 2 линии правки
...
class AclAddNewAction(Construct):
    ...
    def __init__(self):
        ...
        self.pg_query_insert_actions = """
                                  INSERT INTO acl.line2_actions (bar, curvature, action, out_curvature, length_bar,
